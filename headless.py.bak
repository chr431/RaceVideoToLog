...
def run_headless(args: argparse.Namespace) -> None:
	...
	with output_path.open("w", newline="", encoding="utf-8-sig") as fh:
		...
		fh.write(f"# max_speed={args.max_speed}, max_accel={args.max_accel}, div={args.div}, target_h={args.target_h}, pad={args.pad}, backend={backend_actual}, model={args.ocr_model}, buffer={args.buffer}, frame_start={args.frame_start or ''}, frame_end={args.frame_end or ''}\n")
		w = csv.writer(fh)
		for r in rows_data:
